...
class ServerClientTests(unittest.TestCase):
    ...
    def test_topic(self):
        ...
        self.c3.expect(
            ":localhost 332 {c} {ch} {topic}".format(c=self.c3, ch=channel, topic=topic)
        )
    ...
    def test_change_topic_no_such_channel(self):
        ...
        self.c3.expect(
            ":localhost 401 {c} #foo :No such channel".format(c=self.c3.name)
        )
